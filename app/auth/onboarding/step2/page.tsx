...
export default function Step2() {
  ...
  return (
    <div className="flex flex-col items-center px-4 sm:px-6 lg:px-8">
      ...
      <h2 className="text-xl sm:text-2xl font-semibold text-gray-500 mb-6">
        Personaliza tu perfil
      </h2>

      <div
        onClick={handleAvatarClick}
        className="relative w-24 h-24 sm:w-32 sm:h-32 bg-gray-200 rounded-full flex items-center justify-center cursor-pointer overflow-hidden mb-6"
      >
      ...
      <Button
        ...
        onClick={handleNext}
        className="w-full max-w-xs bg-blue-500 text-white py-3"
      >
